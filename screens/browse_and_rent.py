...
def rent_car_page():
    ...
    def filter():    
       """function for the filtering cars according to the priority"""
                                           #filter function
    ...
    def display_cars(cars_per_row=2):         
        """Fucntion to display all the cars in a grid format"""
